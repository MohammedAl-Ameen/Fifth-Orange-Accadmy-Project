...
<?php 
    ...
    if($data_product){
      ...
      <td><img src='../library-origin/images/<?php echo $data["url_image"]; ?>'style="width: 100px;"></td>
      <td><?php echo $data["order_id"]; ?></td>
      <td><?php echo $data["cart_id"]; ?></td>
      <td><?php echo $data["descreption"]; ?></td>
      </tr>
      </tbody>
      <?php $sum += $data["price"]; ?>
...
<script>
    ...
    file.addEventListener("change" , function(){
        ...
        if(file.files.length == 0){
            img.src = "../library-origin/images/<?php echo $data["url_image"]  ?>";
        }else{
