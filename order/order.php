...
<body>
  <div id="app">
    <?php include_once "../assets/PHP_File/Bars.php"?>
      ...
      <li id="Orders" class="active"><a href="../order/order.php" class="nav-link"style='color:#F28123'><i class="far fa-file-alt" ></i><span>Orders</span></a></li>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-md">
                          ...
                          <tr>
                            ...
                            <td><a href="edit_order.php?order_id=<?php echo $value['order_id'] ."&mode=details";?>" class="btn "style='background-color:#F28123;color:white'>Detail</a></td>
                    ...
                    <div class="card-footer text-right">
                      <nav class="d-inline-block" style="display: flex;">
                        <ul class="pagination mb-0">
                          ...
                          <li><a href="edit_order.php?mode=add" class="btn"style='background-color:#F28123;color:white'>Add</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
