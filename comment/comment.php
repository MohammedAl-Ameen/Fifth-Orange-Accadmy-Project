...
<div id="app">
        ...
        <li class="menu-header">Admin user</li>
                    <li id="Dashboard" ><a href="../index.php" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a></li>
                        ...
                        <li class="active"><a href="../comment/comment.php" class="nav-link"style='color:#F28123'><i class="fas fa-pencil-ruler" id="Comments"></i><span>Comments</span></a></li>
                </aside>
            </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-md">
                          ...
                          <tr>
                            ...
                            <td><a href="edit_comment.php?comment_id=<?php echo $value['comment_id'] ."&mode=details";?>" class="btn"style='background-color:#F28123;color:white'>Detail</a></td>
                    ...
                    <div class="card-footer text-right">
                      <nav class="d-inline-block" style="display: flex;">
                        <ul class="pagination mb-0">
                          ...
                          <li><a href="edit_comment.php?mode=add" class="btn"style='background-color:#F28123;color:white'>Add</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
