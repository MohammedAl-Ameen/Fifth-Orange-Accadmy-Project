...
<?php
$selectcomment = "SELECT feedback.text ,user.name FROM feedback INNER JOIN user ON  feedback_id=user.user_id";
...
<div class="swiper mySwiper">
	...
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide button cart-btn" style="border-radius:0px;display:flex;justify-content:center;align-items:center;overflow:hidden">		
			<div>
			<p style='color:white; font-weight: bold;font-size:17px;'><span style='color:white'>User :</span> <?php echo $feedback['name'] ?></p>
			<p style='font-size:16px;color:white'><?php echo $feedback['text'] ?><p>
		</div>
			</div>
		<?php endforeach; ?>
	</div>
