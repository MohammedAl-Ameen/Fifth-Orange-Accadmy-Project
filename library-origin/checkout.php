              ...
              <strong>$<?php echo number_format($total);?></strong>
				...
				<div class="col-lg-4">
					<div class="order-details-wrap">
						...
						<h3>Apply Coupon</h3>
						<div class="coupon-form-wrap" style='margin-bottom:50px' >
							<form action="" method='get'  name="couponField" >
								<span id="error"></span>
                                Coupon code:
								<p><input type="coupon" placeholder="Coupon"  id="coupon" name='coupon' style='border-radius:10px;'></p>
								<p><input type="submit" id="submit" name='submit' value="Apply" style='width:150px'></p>
							</form>
						</div>		
            <?php
                $total = 0;
