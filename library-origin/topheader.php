							...
							<ul>
								...
								<li>
									<div class="header-icons">
										<?php $totalquantity = 0;      foreach($_SESSION['Cart'] as $each_item) {          $totalquantity += $each_item['quantity'];         } ?> 
										<a class="fa badge fa-lg shopping-cart"  href="cart.php"value='<?php echo $totalquantity;?>'><i class="fas fa-shopping-cart" style='font-size:17px ;margin:-15px'></i></a>
