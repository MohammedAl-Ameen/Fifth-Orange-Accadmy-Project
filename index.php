    ...
    <div class="navbar-bg"style='background-color:#F28123'></div>
            ...
            <aside id="sidebar-wrapper" style="height: 100vh;">
                    ...
                    <li class="menu-header">Admin Dashboard</li>
                        <li class="active"><a href="index.php" class="nav-link"style='color:#F28123'><i class="fas fa-fire"></i><span >Dashboard</span></a></li>
        ...
        <div class="main-wrapper main-wrapper-1">
                ...
                <div class="section-header" style="margin-left:-32px;">
                    ...
                    <div class="row">
                        ...
                        <div class="card card-statistic-1">
                            <div class="card-icon "style='background-color:#F28123'>
                    ...
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="order/edit_order.php?order_id=<?php echo $data['order_id'] ."&mode=details";?>" class="btn"style='background-color:#F28123; color:white'>Detail</a>
                        </td>
                      </tr>
                      <?php 
                    $count++;
            ...
            <div class="col-md-4">
              <div class="card card-hero">
                <div class="card-header"style='background:#F28123'>
                  <div class="card-icon">
                  ...
                  <?php 
                      if(count($comment_data) != 0){
                        ...
                        for($i = 0; $i < $length && ($i < 3); $i++ ){ ?>
                            ...
                            <div class="ticket-title"style='color:#F28123'>
                                <h4><?php echo $reverse[$i]["text"];?></h4>
                            </div>
                      <div class="ticket-info">
                        <div><?php echo user_name($reverse[$i]["user_id"] , $user_data)?></div>
                        <div class="bullet"></div>
                        <div class=""style='color:#F28123'><?php echo $reverse[$i]["date"] ?></div>
                      </div>
                    </a>
                    <?php }}else{}?>
        ...
        <div class="footer-left">
          Copyright © 2022 <div class="bullet"></div> Design By <a style='color:#F28123' href="https://www.linkedin.com/in/mohammed-amin-ababneh">Mohammed-Ameen Ababneh</a>
        </div>
