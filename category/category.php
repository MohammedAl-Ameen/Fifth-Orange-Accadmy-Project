...
<div id="app">
        ...
        <li class="menu-header">Admin user</li>
                    <li id="Dashboard" ><a href="../index.php" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a></li>
                        ...
                        <li class="active"><a href="../category/category.php" class="nav-link"style='color:#F28123'><i class="fas fa-bicycle" id="Categories"></i><span>Categories</span></a></li>
                    ...
                    <div class="card-footer text-right">
                      <nav class="d-inline-block" style="display: flex;">
                        <ul class="pagination mb-0">
                          ...
                          <li><a href="edit_category.php?mode=add" class="btn"style='background-color:#F28123;color:white'>Add</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
